...
- todos os filtros devem usar o componente <FilterBar /> que está em src/components/common/FilterBar.tsx
- todas as paginações devem usar o componente <Pagination /> que está em src/components/common/Pagination.tsx
- todos os modais devem usar o componente <Modal /> que está em src/components/common/Modal.tsx
...
- todas as tabelas devem usar o componente <Table /> que está em src/components/common/Table.tsx