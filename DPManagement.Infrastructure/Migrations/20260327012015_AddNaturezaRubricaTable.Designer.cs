...
namespace DPManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260327012015_AddNaturezaRubricaTable")]
    partial class AddNaturezaRubricaTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DPManagement.Domain.Entities.Rubrica", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CodIncCP")
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");

                    b.Property<string>("CodIncFGTS")
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");

                    b.Property<string>("CodIncIRRF")
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");

                    b.Property<string>("CodIncPisPasep")
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");
                    ...
                    b.Property<string>("FimValid")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)");

                    b.Property<string>("IdeTabRubr")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<bool>("IncideIR")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncidePrevidencia")
                        .HasColumnType("boolean");

                    b.Property<string>("IniValid")
                        .IsRequired()
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)");
                    ...
                    b.Property<string>("NatRubr")
                        .HasMaxLength(4)
                        .HasColumnType("character varying(4)");

                    b.Property<int>("Rotina")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DPManagement.Domain.Entities.Vinculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("FormaIngressoId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RegimeJuridicoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DPManagement.Domain.Entities.Vinculo", b =>
                {
                    ...
                    b.HasOne("DPManagement.Domain.Entities.CentroCusto", "CentroCusto")
                        .WithMany("Vinculos")
